...
class Report002IntegrationTest extends IntegrationTestBase {
  ...
  @Test
  void report002KeepsOlderSuccessfulSubmissionWhenNewerReplacementFailsValidation() {
    UUID failedReplacementSubmissionId = UUID.randomUUID();
    UUID olderMatterStartId = UUID.randomUUID();
