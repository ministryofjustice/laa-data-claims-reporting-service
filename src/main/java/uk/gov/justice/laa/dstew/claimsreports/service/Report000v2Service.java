...
/**
 * Report000v2Service is responsible for generating and managing report_000 Version 2.
...
@Slf4j
@Service
public class Report000v2Service extends AbstractReportService {

  private final AppConfig appConfig;

  private static final int MONTHLY_REPORT_DATE = 21;

  public Report000v2Service(JdbcTemplate jdbcTemplate,
  ...
  protected boolean runToday() {
    return appConfig.isForceRunReport000v2() || LocalDate.now(clock).getDayOfMonth() == MONTHLY_REPORT_DATE;
  }
}