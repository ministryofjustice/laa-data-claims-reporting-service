...
public class PrometheusConfiguration {
  ...
  /**
   * This registry is used for the report-level metric push, and so also contains report specific
   * things like success status.
   *
  ...
  public PrometheusMeterRegistry reportPrometheusMeterRegistry() {
    ...
    registry
        .config()
        .meterFilter(
            MeterFilter.deny(id -> id.getName().equals("replication_health_check_status")));
    return registry;
  }
  ...
  /**
   * This registry is used to isolate replication health metric pushes at the end of the process
   * instead of bundling with job registry.
   *
  ...
  */
  ...
  /**
   * Create a gauge for the replication health check status, registered on the replication health
   * registry. Kept separate from report and job gauges as it is not a per-report metric and we
   * don't want duplicate job registry metric updates.
   *
  ...
  public DatabaseHealthGauge createDatabaseHealthGauge(
    ...
    return new DatabaseHealthGauge(
        totalConnections,
        activeConnections,
        idleConnections,
        maxConnections,
  ...
  /** This class defines the replication health metric we push to Prometheus. */
  public record DatabaseHealthGauge(
      Gauge totalConnections,
      Gauge activeConnections,
      Gauge idleConnections,
      Gauge maxConnections,
      Gauge activeUtilisation,
      Gauge totalUtilisation) {}
   ...
   */
  @Bean
  public CustomReportGauges createReportGauges(
  ...
  public record CustomReportGauges(
      Gauge reportSuccessful,
      Gauge reportTotalTime,
      Gauge dataRefreshTimeMs,
      Gauge generatedTimeMs,
      Gauge rowsWritten,
      Gauge reportFileSize,
      Gauge uploadTimeMs,
      Gauge encodingCheckTimeMs) {
