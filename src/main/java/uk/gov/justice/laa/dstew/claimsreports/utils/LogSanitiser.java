 ...
 *
 * <p>Designed to reduce risks of log forging (CRLF injection) and ensure
 * filenames contain only safe, predictable characters.
 */
public final class LogSanitiser {
   ...
   * are replaced with underscores to prevent log forging / fake log entries.
   *
