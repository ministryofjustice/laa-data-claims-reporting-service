...
/**
 * Represents a summary of replication metrics for a specific database table.
 * This record captures key information that helps in assessing the replication
 * process, including the table name, the number of records present, and updates
 * occurring during previous day.
 *
