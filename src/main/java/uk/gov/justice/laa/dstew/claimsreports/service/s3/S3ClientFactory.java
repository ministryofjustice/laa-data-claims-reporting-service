...
public class S3ClientFactory {
  ...
  // These are just best-guesses at this point, no clue how long say a 3GB file would actually take
  // to upload.
  ...
  public S3Client createS3Client(String awsRegion) {
    ...
    return S3Client.builder().region(Region.of(awsRegion)).overrideConfiguration(config).build();
  }
}
