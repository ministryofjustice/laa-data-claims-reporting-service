 ...
 */
class Report013v2ServiceTest {

  private Report013v2Service service;
  ...
  void setUp() {
    ...
    service = new Report013v2Service(jdbcTemplate, s3ClientWrapper, creationService, metricsHandler, fixedClock);
  }
  ...
  void generateReport_shouldCallTheRightServicesWithTheRightValues(){
    ...
    verify(s3ClientWrapper).uploadFile(any(File.class), eq("reports/daily/report_013_v2_2025-12-22.csv"));
  }
