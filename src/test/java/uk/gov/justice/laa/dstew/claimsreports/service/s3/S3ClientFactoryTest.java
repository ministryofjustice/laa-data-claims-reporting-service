...
class S3ClientFactoryTest {
    ...
    void shouldCreateS3ClientWithApiTimeoutsSet() {
        ...
        assertEquals(Optional.of(Duration.ofSeconds(180)), createdClient.serviceClientConfiguration().overrideConfiguration().apiCallTimeout());
        assertEquals(Optional.of(Duration.ofSeconds(60)), createdClient.serviceClientConfiguration().overrideConfiguration().apiCallAttemptTimeout());
